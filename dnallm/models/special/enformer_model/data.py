...
class FastaInterval:
    ...
    def __call__(self, chr_name, start, end, return_augs=False):
        ...
        # returns the shift integer as well as the bool
        # (for whether reverse complement was activated)
...
class GenomeIntervalDataset(Dataset):
    def __init__(
        ...
        # if the chromosome name in the bed file is different than
        # the keyname in the fasta can remap on the fly
