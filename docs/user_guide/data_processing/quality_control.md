...
The `dnallm.datahandling.DNADataset.validate_sequences` function is designed for this purpose.

<!-- skip-verify: incomplete code example with missing implementation -->
```python
