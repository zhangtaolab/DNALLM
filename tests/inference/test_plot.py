...
class TestPrepareData:
    ...
    def test_prepare_data_binary_classification(self):
        ...
        assert bars_data['accuracy'] == TEST_ACCURACY_VALUES, "Accuracy should match expected values"
        ...
        assert len(curves_data['ROC']['models']) == 10, "ROC models should have 10 entries (5 points * 2 models)"
        assert len(curves_data['PR']['models']) == 10, "PR models should have 10 entries (5 points * 2 models)"
    ...
    def test_prepare_data_regression(self):
        ...
        assert len(scatter_data['model1']['predicted']) == 4, "Model1 should have 4 predicted values"
        assert len(scatter_data['model2']['predicted']) == 4, "Model2 should have 4 predicted values"
...
class TestPlotCurve:
    ...
    def test_plot_curve_separate(self):
        ...
        # Validate each individual chart
        for curve_name, chart in charts.items():
            assert_chart_valid(chart)
...
class TestPlotAttentionMap:
    ...
    def test_plot_attention_map_basic(self):
        ...
        mock_tokenizer.convert_ids_to_tokens.return_value = ["A", "T", "C", "G"]
    ...
    def test_plot_attention_map_with_save(self):
        ...
        try:
            # Test save functionality with file path
            chart = plot_attention_map(attentions, sequences, mock_tokenizer, save_path=pdf_file_path)
    ...
    def test_plot_attention_map_different_sequence_lengths(self):
        ...
        mock_tokenizer.convert_ids_to_tokens.return_value = ["A", "T", "C", "G"] * 2 + ["A", "T"]
    ...
    def test_plot_attention_map_pdf_output_quality(self):
        ...
        mock_tokenizer.convert_ids_to_tokens.return_value = ["A", "T", "C", "G"] * 2
...
class TestPlotEmbeddings:
    ...
    def test_plot_embeddings_tsne(self):
        ...
        with patch('sklearn.manifold.TSNE') as mock_tsne:
            ...
            chart = plot_embeddings(hidden_states, attention_mask, "t-SNE", labels, label_names)
            assert_chart_valid(chart)
    ...
    def test_plot_embeddings_separate(self):
        ...
        with patch('sklearn.manifold.TSNE') as mock_tsne:
            ...
            hidden_states = [np.random.rand(10, 5, 128), np.random.rand(10, 5, 128)]
            ...
            # Validate each individual chart
            for layer_name, chart in charts.items():
                assert_chart_valid(chart)
    ...
    def test_plot_embeddings_with_save(self):
        ...
        with patch('sklearn.manifold.TSNE') as mock_tsne:
            ...
            try:
                # Test save functionality with file path
                chart = plot_embeddings(hidden_states, attention_mask, "t-SNE", save_path=pdf_file_path)
    ...
    def test_plot_embeddings_pdf_output_quality(self):
        ...
        with patch('sklearn.manifold.TSNE') as mock_tsne:
            ...
            try:
                # Generate and save chart
                chart = plot_embeddings(hidden_states, attention_mask, "t-SNE", labels, label_names, save_path=pdf_file_path)
...
class TestEdgeCases:
    ...
    def test_plot_curve_missing_data_keys(self):
        ...
        data = {
            'ROC': {'models': ['model1', 'model1'], 'fpr': [0.0, 1.0], 'tpr': [0.0, 1.0]},  # Complete data
            'PR': {'models': ['model1', 'model1'], 'precision': [0.8, 0.9], 'recall': [0.0, 1.0]}  # Complete data
        }
...
class TestPerformance:
    ...
    def test_large_dataset_performance(self):
        ...
        assert processing_time < 1.0, f"Large dataset processing took {processing_time:.3f}s, should be under 1.0s"
    ...
    def test_memory_efficiency(self):
        ...
        for chart_name, individual_chart in chart.items():
    ...
    def test_concurrent_pdf_generation(self):
        ...
        try:
            ...
            assert total_time < 5.0, f"Concurrent PDF generation took {total_time:.3f}s, should be under 5.0s"
    ...
    def test_large_chart_rendering(self):
        ...
        # Validate performance characteristics
        assert rendering_time < 2.0, f"Large chart rendering took {rendering_time:.3f}s, should be under 2.0s"
        assert_chart_valid(chart)
...
class TestPDFOutputQuality:
    ...
    def test_pdf_content_validation(self):
        ...
        try:
            ...
            with open(pdf_path, 'rb') as f:
                ...
                assert header.startswith('%PDF'), f"Invalid PDF header: {header}"
    ...
    def test_pdf_error_handling(self):
        ...
        try:
            ...
            # If it does crash, it should be a reasonable error
            assert "Permission denied" in str(e) or "No such file or directory" in str(e), f"Unexpected error: {e}"
    ...
    def test_demo_pdf_generation(self):
        ...
        with patch('sklearn.manifold.TSNE') as mock_tsne:
            ...
            plot_embeddings(hidden_states, attention_mask, "t-SNE", labels, label_names, save_path=embeddings_pdf)
        ...
        print(f"✅ Generated demonstration PDF files:")
        print(f"  - {bar_pdf}")
        print(f"  - {curve_pdf}")
        print(f"  - {scatter_pdf}")
...
if __name__ == "__main__":
    ...
    pytest.main([
        ...
        "--pdf-output-dir", str(PDF_OUTPUT_DIR)  # Custom PDF output directory
    ])
